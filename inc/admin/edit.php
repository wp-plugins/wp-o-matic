      ...
      <div id="edit_sections">                          
        ...
        <div class="section" id="section_options">
          ...
          <div class="text">
            ...
            <?php echo select_tag('campaign_author', options_for_select($author_usernames, _data_value($data['main'], 'author', 'admin'), 'include_custom=Select one')) ?>
            ...
            <ul>
              ...
              <li>
                <div class="text">
                  ...
                  <?php echo select_tag('campaign_tool_changeauthor', options_for_select($author_usernames, _data_value($data['main'], 'author', 'admin'), 'include_custom=Select one')) ?>
