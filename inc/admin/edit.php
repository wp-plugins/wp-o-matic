    ...
    <form id="edit_campaign" action="" method="post" accept-charset="utf-8">
      ...
      <div id="edit_sections">                          
          ...
          <ul id="categories">
            ...
            <?php if(isset($data['categories']['new'])): ?>
              ...
              <li>
                ...
                <?php echo input_tag('campaign_newcatname[]', $catname, 'id=campaign_newcatname_' . $i) ?>
              </li>
              <?php endforeach ?>
            <?php endif ?>
          </ul>          
        ...
        <div class="section" id="section_rewrite">
          <p><?php _e('Want to transform a word into another? Or link a specific word to some website?', 'wpomatic') ?></p>  
          <p><?php printf(__('You can read about using <a href="%s" class="help_link">regular expressions</a>', 'wpomatic'), $this->helpurl . 'regular_expressions') ?></p>
        ...
        <div class="section" id="section_options">
          ...
          <div class="checkbox">
            ...
            <div id="post_template" class="textarea <?php if(_data_value($data['main'], 'template')) echo 'current' ?>">
              <?php echo textarea_tag('campaign_template', _data_value($data['main'], 'template', '{content}')) ?>
              <a href="#" class="enlarge_link"><?php _e('Enlarge', 'wpomatic') ?></a>
            ...
            <p class="note"><?php printf(__('Read about <a href="%s" class="help_link">post templates</a>, or check some <a href="%s" class="help_link">examples</a>', 'wpomatic'), $this->helpurl . 'campaign_templates', $this->helpurl . 'templates_examples') ?></p>            
          </div>
          ...
          <div class="checkbox">
            ...
            <p class="note"><?php _e('Use the original date from the post instead of the time the post is created by WP-o-Matic.', 'wpomatic') ?> <a href="<?php echo $this->helpurl ?>feed_date" class="help_link"><?php _e('More', 'wpomatic') ?></a></p>
          </div>    
          
          <div class="checkbox">
            <?php echo label_for('campaign_dopingbacks', __('Perform pingbacks', 'wpomatic')) ?>
            <?php echo checkbox_tag('campaign_dopingbacks', 1, _data_value($data['main'], 'dopingbacks', true)) ?>
          </div>         
          ...
          <div class="text">
            <?php echo label_for('campaign_author', __('Author username:', 'wpomatic')) ?>
            <?php echo input_tag('campaign_author', _data_value($data['main'], 'author', 'admin')) ?>
          </div>
          
          <div class="radio">
            <label class="main"><?php _e('Discussion options:', 'wpomatic')?></label>
            
            <?php echo checkbox_tag('campaign_allowcomments', 1, _data_value($data['main'], 'allowcomments', true)) ?>
            <?php echo label_for('campaign_allowcomments', __('Allow comments', 'wpomatic')) ?>
            ...
            <ul>
              ...
              <li>
                <div class="text">
                  ...
                  <input type="text" name="campaign_tool_changeauthor" id="campaign_tool_changeauthor" value="" />
