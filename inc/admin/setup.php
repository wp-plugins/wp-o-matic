  ...
  <div id="setup" class="wrap">
    ...
    <ol id="setup_steps">
      ...
      <li id="step_3">
        ...
        <p><input type="checkbox" name="option_unixcron" checked="checked" /> <label for="option_unixcron"><?php _e('I\'ll be using a cron job (uncheck if you want pseudo-cron functionality)', 'wpomatic') ?></label></p>
      </li>
