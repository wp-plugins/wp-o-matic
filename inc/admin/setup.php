    ...
    <div id="setup" class="wrap">
      ...
      <ol id="setup_steps">
        ...
        <li id="step_2">
          ...
          <p><strong><?php _e('GMT time:', 'wpomatic') ?></strong> <?php echo gmdate('d F, Y h:i', current_time('timestamp', true)) ?> <br />
             <strong><?php _e('Your time:', 'wpomatic') ?></strong> <?php echo gmdate('d F, Y h:i', current_time('timestamp')) ?> </p>
        </li>
        ...
        <li id="step_3">
          ...
          <p><?php printf(__('Add this line to your crontab, or use your web panel of choice interface. %s', 'wpomatic'), ($nophp) ? __('<strong>Warning!</strong> WP-o-Matic has been unable to detect the location of the php command. This means you\'ll have to check it exists from the command line or find it by your own', 'wpomatic') : '') ?></p>
          ...
          <p><input type="checkbox" name="option_unixcron" checked="checked" id="option_unixcron" /> <label for="option_unixcron"><?php _e('I\'ll be using a cron job (uncheck if you want pseudo-cron functionality)', 'wpomatic') ?></label></p>
        </li>
